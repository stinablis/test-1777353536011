...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our \'test\' product is a cutting-edge solution designed to streamline processes and increase efficiency, providing our customers with a competitive edge in their respective markets. With its advanced features and user-friendly interface, this product is an essential tool for any business looking to stay ahead of the curve.', i: 'https://images.pexels.com/photos/9227854/pexels-photo-9227854.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'The \'test\' product is a versatile and reliable solution that offers a range of benefits, including enhanced productivity, improved accuracy, and reduced costs. Our team of experts has carefully crafted this product to meet the unique needs of our customers, providing a tailored approach to help them achieve their goals.', i: 'https://images.pexels.com/photos/13005311/pexels-photo-13005311.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Our \'test\' product is a game-changer in the industry, offering a unique combination of features and functionality that sets it apart from the competition. With its advanced technology and innovative design, this product is poised to revolutionize the way our customers approach their business operations.', i: 'https://images.pexels.com/photos/7505180/pexels-photo-7505180.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'The \'test\' product is a comprehensive solution that addresses the complex needs of our customers, providing a holistic approach to managing their operations. Our team has carefully designed this product to be scalable, flexible, and customizable, ensuring that it meets the evolving needs of our customers.', i: 'https://images.pexels.com/photos/12913038/pexels-photo-12913038.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Our \'test\' product is a specialized solution that caters to the specific requirements of our customers, offering a tailored approach to help them achieve their objectives. With its advanced features and expert support, this product is an essential tool for any business looking to optimize its operations and drive success.', i: 'https://images.pexels.com/photos/15837845/pexels-photo-15837845.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Test, we are dedicated to providing innovative solutions to meet the evolving needs of our customers. With a strong foundation in product development, we strive to deliver high-quality products that exceed expectations. Our team of experts is committed to fostering a culture of excellence and continuous improvement.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to become a leading provider of exceptional products that transform the way our customers live and work.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to design, develop, and deliver products that make a positive impact on our customers\' lives, while maintaining the highest standards of quality, integrity, and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Test, our first core value, \'tets\', represents our commitment to embracing challenges and finding creative solutions to drive innovation and growth.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value, \'test\', reflects our dedication to pushing boundaries, exploring new ideas, and continuously improving our products and services to meet the changing needs of our customers.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/8475194/pexels-photo-8475194.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/29267512/pexels-photo-29267512.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
